...
namespace Leap.Unity.PhysicalInterfaces {
  ...
  public class InteractionObjectHandle : MonoBehaviour,
    ...
    void Start() {
      ...
      if (anchObj != null) {
        anchObj.OnPostTryAnchorOnGraspEnd += onAnchObjGraspEnd;
      }
      else {
    ...
    private void onAnchObjGraspEnd(AnchorableBehaviour anchObj) {
      onGraspEnd();
    }
    ...
    public Movement movement {
      get { return new Movement(intObj.rigidbody.velocity, intObj.rigidbody.angularVelocity); }
    }
