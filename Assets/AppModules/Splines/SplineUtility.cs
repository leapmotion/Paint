...
namespace Leap.Unity.Splines {
  ...
  public static class SplineUtility {
    ...
    public static class MeshGen {
      ...
      public static void GenerateQuadSplineMesh(ref List<Vector3> verts, ref List<int> indices,
                                            ISpline spline, float splineThickness, Vector3 initNormalFacingReference,
  ...
  public struct SplineInterpolatorEnumerator {
    ...
    public SplineInterpolatorEnumerator(ISpline spline, float minStepProduct) {
      started = false;
      this.spline = spline;
  ...
  public struct SplineFragmentEnumerator {
    ...
    public SplineFragmentEnumerator(ISpline spline, float minStepProduct) {
  ...
  public static class ISplineExtensions {
    ...
    /// </remarks>
    public static SplineInterpolatorEnumerator Traverse(this ISpline spline, float minInterstepDotProduct = 0.9F) {
    ...
    /// </remarks>
    public static SplineFragmentEnumerator TraverseFragments(this ISpline spline, float minIntersegmentDotProduct = 0.9F) {
